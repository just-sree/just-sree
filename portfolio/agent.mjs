...
export function previewReply(message, history = []) {
  ...
  if (/contact|email|reach|availability|available|rates|salary/.test(query)) return { answer: 'Email is best: sreechackoth@gmail.com. He is also on LinkedIn. Rates and compensation are for him to discuss directly.', project: null, contact: true };
