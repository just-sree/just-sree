...
const posting = 'Applied ML Engineer. Requirements: Python, time-series forecasting, LLM agents, Docker, Kafka, Java.';
...
test('preview match rates skills from approved facts and reports gaps without calling a provider', async () => {
  ...
  assert.equal(byName.Kafka.strength, 'partial');
  assert.equal(byName.Kafka.source, null);
  assert.deepEqual(byName.Java, { requirement: 'Java', strength: 'none', evidence: 'Not in the portfolio notes. Ask Sree directly.', source: null });
