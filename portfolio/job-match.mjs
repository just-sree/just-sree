...
const vocabulary = [
  ...
  ['LangChain or LangGraph', /langchain|langgraph/, 'partial', 'Listed on the resume.', 'resume'],
  ['RAG', /\brag\b|retrieval/, 'partial', 'Listed on the resume; the churn project proposes a RAG workflow.', 'churn'],
  ...
  ['Kubernetes', /kubernetes|\bk8s\b/, 'none'], ['Spark', /\bspark\b|pyspark/, 'none'], ['Java', /\bjava\b/, 'none'],
  ['Scala', /\bscala\b/, 'none'], ['C++', /c\+\+/, 'none'], ['Rust', /\brust\b/, 'none'],
  ['Google Cloud', /\bgcp\b|google cloud|vertex ai/, 'none'], ['Snowflake', /snowflake/, 'none'], ['Databricks', /databricks/, 'none'],
  ['Airflow', /airflow/, 'none'], ['Kafka', /kafka/, 'none'], ['Terraform', /terraform/, 'none'],
